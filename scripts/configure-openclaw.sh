...
echo -e "${GREEN}╠══════════════════════════════════════════════════════════════════╣${NC}"
echo -e "${GREEN}║${NC}"
echo -e "${GREEN}║${NC}  ${CYAN}1. Open an SSH tunnel (keep this terminal open):${NC}"
echo -e "${GREEN}║${NC}     ssh -L 18789:localhost:18789 ${SSH_USER}@${VM_IP}"
echo -e "${GREEN}║${NC}"
echo -e "${GREEN}║${NC}  ${CYAN}2. Open the dashboard in your browser:${NC}"
echo -e "${GREEN}║${NC}     ${DASHBOARD_LINE}"
echo -e "${GREEN}║${NC}"
echo -e "${GREEN}║${NC}  ${CYAN}3. Click Connect — then approve the browser device (on the VM):${NC}"
echo -e "${GREEN}║${NC}     ssh ${SSH_USER}@${VM_IP}"
